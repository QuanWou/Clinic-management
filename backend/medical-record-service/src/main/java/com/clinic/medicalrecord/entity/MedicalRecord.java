...
public class MedicalRecord {
    ...
    /** Stable chart number generated by PostgreSQL, never used as a foreign key. */
    @Generated(event = EventType.INSERT)
    @Column(name = "record_code", nullable = false, unique = true, length = 24, insertable = false, updatable = false)
