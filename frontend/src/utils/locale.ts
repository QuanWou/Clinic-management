...
const statusLabels: Record<string, string> = {
  ...
  CANCELLED: 'Đã hủy', PAID: 'Đã thanh toán', UNPAID: 'Chưa thanh toán', REFUNDED: 'Đã hoàn tiền',
  RECONCILIATION_REQUIRED: 'Cần đối soát',
  WAITING: 'Đang chờ', CALLED: 'Đã gọi', IN_PROGRESS: 'Đang khám', SKIPPED: 'Đã bỏ qua',
  ORDERED: 'Đã chỉ định', COLLECTED: 'Đã lấy mẫu', PROCESSING: 'Đang xử lý mẫu',
  RESULTED: 'Đã có kết quả', RELEASED: 'Đã công bố',
