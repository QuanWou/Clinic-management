...
const noop = vi.fn();
const bookings: AppointmentResponse[] = [
  { id: 'booking-pending', patientId: 'patient-1', doctorId: 'doctor-1', appointmentDate: '2026-09-20', startTime: '08:00', endTime: '08:30', status: 'PENDING' },
  { id: 'booking-ready', patientId: 'patient-2', doctorId: 'doctor-1', appointmentDate: '2026-09-20', startTime: '08:30', endTime: '09:00', status: 'CONFIRMED' },
  { id: 'booking-checked', patientId: 'patient-3', doctorId: 'doctor-1', appointmentDate: '2026-09-20', startTime: '09:00', endTime: '09:30', status: 'CONFIRMED' },
  { id: 'other-date', patientId: 'patient-4', doctorId: 'doctor-1', appointmentDate: '2026-09-21', startTime: '09:30', endTime: '10:00', status: 'PENDING' }
];
const queue: ReceptionVisitResponse[] = [
  { id: 'visit-1', appointmentId: 'booking-checked', patientId: 'patient-3', doctorId: 'doctor-1', visitDate: '2026-09-20', queueNumber: 2, status: 'WAITING', checkedInAt: '2026-09-20T08:30:00', startedAt: null, completedAt: null },
  { id: 'other-visit', appointmentId: 'other-date', patientId: 'patient-4', doctorId: 'doctor-1', visitDate: '2026-09-21', queueNumber: 3, status: 'CALLED', checkedInAt: '2026-09-21T08:30:00', startedAt: null, completedAt: null }
];
